  ...
  <div class="seller" ref="seller">
    <div class="seller-content">
      ...
      <div class="pics">
        ...
        <div class="pic-wrapper" ref="picWrapper">
          <ul class="pic-list" ref="picList">
            <li class="pic-item" v-for="(item,picIndex) in seller.pics" :key="picIndex">
      ...
      <div class="info">
        ...
        <ul>
          <li class="info-item border-1px" v-for="(info,infoIndex) in seller.infos" :key="infoIndex">{{info}}</li>
        </ul>
      </div>
    </div>
  </div>
