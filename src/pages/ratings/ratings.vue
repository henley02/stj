  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-wrapper">
      ...
      <rating-select :selectType="selectType" :onlyContent="onlyContent" :desc="desc"
                     :ratings="ratings" @select="selectRating" @toggle="toggleContent"></rating-select>
          ...
          <li class="rating-item border-1px" v-for="rating in ratings"  v-show="needShow(rating.rateType,rating.text)">
            ...
            <div class="content">
              ...
              <div class="recommend" v-show="rating.recommend && rating.recommend.length>0">
                ...
                <span v-for="(text,recommendIndex) in rating.recommend" :key="recommendIndex"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      async init() {
        let res = await this.$http.get('/api/ratings').then((response) => response.body);
        if (res.errno === 0) {
